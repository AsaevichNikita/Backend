package org.tinkoff.service.keycloak;
...
import org.tinkoff.config.KeycloakConfiguration;
import org.tinkoff.dto.keycloak.*;
import org.tinkoff.mapper.keycloak.AccessTokenMapper;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import static org.tinkoff.config.KeycloakConfiguration.*;
...
public class KeycloakService {
    ...
    public void addUser(UserRegisterDto dto) {
        ...
        try (var ignored = usersResource.create(user)) {
            ...
            RoleRepresentation role = realmResource.roles().get(dto.getUserRoleDto().toLowerCase()).toRepresentation();
